...
int main() {
    ...
    char letra;
    bool acabou = false;
    //ArqTextoC arq( "eleicao_2020", eleicao );
    //ArqTextoCPP arq( "eleicao_2020", eleicao );
    ArqBinCPP arq( "eleicao_2020", eleicao );
    arq.ler();
    //arqBin.gravar();
    while (!acabou)
    {
        switch( menu (eleicao.getEstado()) )
        {
            ...
            case 12:                        //2. remover aluno
                limparTela();
                cout << "Entre com o cpf do aluno" << endl;
                cin >> aux;
                cin.ignore();
                eleicao.getEleitores().remover(aux);
                arq.gravar();
            ...
            case 13:                        //3. alterar aluno
                ...
                cin.ignore();
                eAux.ler();
                eleicao.getEleitores().alterar(aux, eAux);
                arq.gravar();
                cout << "Removido com sucesso!";
                pausar();
                break;
            ...
            case 16:                        //6. remover candidato
                limparTela();
                cout << "Entre com o numero do candidato" << endl;
                cin >> numero;
                cin.ignore();
                eleicao.getCandidatos().remover(numero);
                arq.gravar();
                cout << "Removido com sucesso!";
                pausar();
                break;
            case 17:                        //7. alterar candidato
                ...
                cin.ignore();
                cAux.ler();
                eleicao.getCandidatos().alterar(numero, cAux);
                arq.gravar();
                cout << "Removido com sucesso!";
                pausar();
                break;            
